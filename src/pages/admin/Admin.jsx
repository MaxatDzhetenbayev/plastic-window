      ...
      {isLoading ? (
        ...
        <Box sx={{ mt: 6 }}>
          <Box>
            ...
            <Box>
              <Box
                sx={{ display: "flex", gap: "40px", flexWrap: "wrap", mt: 2 }}
              >
                {data.statusCounts.map(({ status, count }) => (
                  ...
                  >
                    <Typography sx={{ fontSize: "32px" }}>{count}</Typography>
          ...
          <Box>
            ...
            <BarChart
              sx={{ mt: 6 }}
              series={[{ data: data.dailySales.map((day) => day.count) }]}
              height={290}
              xAxis={[
                {
                  data: data.dailySales.map((day) => day.date),
                  scaleType: "band",
                },
              ]}
